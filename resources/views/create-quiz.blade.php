...
@section('content')
    <div id="create-quiz-panel-container" class="flex-1 bg-gradient-to-r from-black to-indigo-300 via-indigo-800 min-w-screen flex justify-center items-center">
