<div id="add-quiz-topic-modal-background" class="absolute top-0 left-0 bottom-0 right-0 flex flex-col justify-center items-center w-full bg-black bg-opacity-70" x-show="addQuizTopicModalOpen">
